function ensamblaje_adaptive(M, max_r,min_mort,n_tray,adaptab)
...
[F,X,R,L] = is_feasible_adaptive(M,max_r,min_mort, [] ,0); % Calculamos los "r" consistentes con equilibrios positivos, si los hay
...
for i=1:length(M)
    ...
    E = M(S,S) ;
    [F,X,RR,L] = is_feasible_adaptive(E,max_r,min_mort,R(S),adaptab);
    Eq = -E\RR ;
