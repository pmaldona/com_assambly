...
![img](https://latex.codecogs.com/svg.latex?\Large&space;A_{ij}=f_{t}\frac{b_{ij}C_{ij}}{msp+(1-msp)\left(\sum_{k\in\mathcal{T}_i}C_{ik}+tp\sum_{k\in0%20\mathcal{A}_i\setminus\mathcal{T}_i}C_{ik}\right)})
